...
CREATE TABLE [easyrental_stg].[customers] (
...
CREATE TABLE [easyrental_stg].[reservations] (
  [id] int PRIMARY KEY IDENTITY(1, 1),
  [customer_id] int,
  [car_id] int,
...
CREATE TABLE [easyrental_stg].[cars] (
  [id] int PRIMARY KEY IDENTITY(1, 1),
...
CREATE TABLE [easyrental_stg].[car_categories] (
  [id] int PRIMARY KEY IDENTITY(1, 1),
  [name] nvarchar(255),
  [daily_rate] decimal
)
...
CREATE TABLE [easyrental_stg].[branches] (
  [id] int PRIMARY KEY IDENTITY(1, 1),
  [name] nvarchar(255),
  [city] nvarchar(255),
  [capacity] int
...
CREATE TABLE [easyrental_stg].[payments] (
  [id] int PRIMARY KEY IDENTITY(1, 1),
  [reservation_id] int,
  [amount] decimal,
