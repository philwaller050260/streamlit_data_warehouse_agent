...
OPENROUTER_MODELS = {
    "Nemotron 3 Super (NVIDIA)": "nvidia/nemotron-super-49b-v1:free",
    "Step 3.5 Flash (StepFun)":  "stepfun-ai/step-3.5-flash:free",
    "Trinity Large (Arcee)":     "arcee-ai/trinity-large-preview:free",
